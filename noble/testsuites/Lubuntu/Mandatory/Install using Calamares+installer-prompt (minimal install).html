...
<dl>
    ...
    <dt>At the "Customize" pane, select "Minimal Installation" and click "Next"</dt>
        <dd>"Download and install updates following installation" should be unchecked</dd>
        <dd>The "Install additional third-party packages" should disappear</dd>
    ...
    <dt>Allow the machine to reboot</dt>
        ...
        <dd>The installation should consist of the basic desktop environment, and not things like a web browser</dd>
</dl>
