...
<dl>
    <dt>Boot with qemu</dt>
        <dd>Follow instructions from the <a href="https://canonical-ubuntu-boards.readthedocs-hosted.com/en/latest/how-to/qemu-riscv/">documentation</a> on how to boot with QEMU</dd>
