...
<dl>
    ...
    <dt>At the "Partions" pane, select the "Erase disk" radio button</dt>
    ...
    <dt>Check the "Encrypt system" checkbox</dt>
        <dd>Next to the checkbox, two prompts are shown: "Passphrase" and "Confirm passphrase"</dd>
    <dt>Enter two matching passphrases in the prompts and click "Next"</dt>
        <dd>Upon success, a green checkmark is shown to the right of the prompts</dd>
        <dd>The "After" partition layout at the bottom should show the target partition for the installation as LUKS2</dd>
