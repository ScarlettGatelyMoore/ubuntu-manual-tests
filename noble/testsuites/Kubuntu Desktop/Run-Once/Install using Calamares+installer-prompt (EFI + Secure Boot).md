...
<dl>
    <dt>Before running this test, ensure that you are using an EFI firmware with Secure Boot enabled to boot</dt>
    ...
    <dt>At the "Partions" pane, select the "Erase disk" radio button and click "Next"</dt>
        <dd>In the top left corner, "EFI" is displayed</dd>
