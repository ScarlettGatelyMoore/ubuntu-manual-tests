...
<dl>
    <dt>Before starting this test, make sure you are NOT connected to the Internet</dt>
    ...
    <dt>At the "Customize" pane, click "Next"</dt>
        <dd>"Normal Installation" should be selected, but there is also a option for "Minimal Installation"</dd>
