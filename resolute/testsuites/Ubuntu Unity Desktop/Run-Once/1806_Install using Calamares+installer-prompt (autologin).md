...
<dl>
    ...
    <dt>At the "Users" pane, enter details about the main system user, check "Log in automatically without asking for the password,"  and click "Next"</dt>
    ...
    <dt>Allow the machine to reboot</dt>
        ...
        <dd>No login screen is shown and no password is required to get to the desktop environment</dd>
</dl>
